...
{
Extension Get_Extension_By_EXTENSION_ID ( Int32? EXTENSION_ID);
...
Extension Get_Extension_By_EXTENSION_ID_Adv ( Int32? EXTENSION_ID);
Table Get_Table_By_TABLE_ID_Adv ( Int32? TABLE_ID);
User Get_User_By_USER_ID_Adv ( long? USER_ID);
List<Extension> Get_Extension_By_EXTENSION_ID_List ( List<Int32?> EXTENSION_ID_LIST);
...
List<Extension> Get_Extension_By_EXTENSION_ID_List_Adv ( List<Int32?> EXTENSION_ID_LIST);
...
List<Extension> Get_Extension_By_OWNER_ID ( Int32? OWNER_ID);
List<Table> Get_Table_By_OWNER_ID ( Int32? OWNER_ID);
List<Table> Get_Table_By_DEPO ( string DEPO);
List<User> Get_User_By_OWNER_ID ( Int32? OWNER_ID);
List<User> Get_User_By_USERNAME ( string USERNAME);
List<Extension> Get_Extension_By_OWNER_ID_Adv ( Int32? OWNER_ID);
List<Table> Get_Table_By_OWNER_ID_Adv ( Int32? OWNER_ID);
List<Table> Get_Table_By_DEPO_Adv ( string DEPO);
List<User> Get_User_By_OWNER_ID_Adv ( Int32? OWNER_ID);
List<User> Get_User_By_USERNAME_Adv ( string USERNAME);
List<Extension> Get_Extension_By_Criteria ( string EXTENSION_TYPE, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Extension> Get_Extension_By_Where ( string EXTENSION_TYPE, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
void Delete_Extension_By_OWNER_ID ( Int32? OWNER_ID);
void Delete_Table_By_OWNER_ID ( Int32? OWNER_ID);
void Delete_Table_By_DEPO ( string DEPO);
